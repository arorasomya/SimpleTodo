...
import static com.example.arorasomya64.simpletodo.MainActivity.ITEM_POSITION;
import static com.example.arorasomya64.simpletodo.MainActivity.ITEM_TEXT;
...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        position = getIntent().getIntExtra(ITEM_POSITION, 8);
    ...
    public void onSaveItem(View v) {
        ...
        Intent i = new Intent();
        // pass updated item description to the intent as an extra
